...
@Entity
@Table(name = "CEMEC_CATEGORIA_PUESTO")
public class CemecCategoriaPuesto implements Serializable {
    private static final long serialVersionUID = 4570024055644232399L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ID_CATEGORIA_PUESTO", nullable = false)
    private Integer id;

    @Column(name = "DES_CATEGORIA_PUESTO", nullable = false, length = 100)
    ...
    public String getDesCategoriaPuesto() {
        return desCategoriaPuesto;
    }

    public void setDesCategoriaPuesto(String desCategoriaPuesto) {
        this.desCategoriaPuesto = desCategoriaPuesto;
    }
