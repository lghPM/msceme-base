...
@Entity
@Table(name = "CEMEC_TIPO_MEZCLA")
public class CemecTipoMezcla implements Serializable {
    private static final long serialVersionUID = 97032330789636700L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ID_TIPO_MEZCLA", nullable = false)
    private Integer id;

    @Column(name = "NOM_TIPO_MEZCLA", nullable = false, length = 50)
    ...
    public String getNomTipoMezcla() {
        return nomTipoMezcla;
    }

    public void setNomTipoMezcla(String nomTipoMezcla) {
        this.nomTipoMezcla = nomTipoMezcla;
    }
